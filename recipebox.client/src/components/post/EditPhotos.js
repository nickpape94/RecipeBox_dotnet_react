...
const EditPhotos = ({ getPost, post: { post }, match, auth: { user, loading } }) => {
	...
	return (
		<Fragment>
			...
			{files && !loading && <PhotoManagement files={files} setFiles={setFiles} />}
...
export default connect(mapStateToProps, { getPost })(withRouter(EditPhotos));
