...
namespace RecipeBox.API.Dtos.PostDtos
{
    ...
    {
        [Required]
        [StringLength(60, MinimumLength = 5, ErrorMessage = "Name of dish must be between 3 and 60 characters long.")]
        public string NameOfDish { get; set; }
        
        [StringLength(300, MinimumLength = 5, ErrorMessage = "Description must be between 5 and 500 characters long.")]
